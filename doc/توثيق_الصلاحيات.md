...
**ملاحظة:** المسارات `/dashboard` و `/dashboard/approvals` متاحة لجميع من سجّل دخوله ولا تحتاج صلاحية قسم.
...
1. **تحديث الصلاحيات**: المستخدم يرى التغييرات عند تسجيل الدخول مرة أخرى. إذا رغبت في تحديث فوري بدون إعادة تسجيل دخول، يُحتاج إلى آلية مثل إعادة جلب بيانات المستخدم بعد تعديل الأدوار.
